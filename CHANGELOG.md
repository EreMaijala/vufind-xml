...
This is the first release under the library's new home. It does not contain functional changes from earlier (FinnaXml) versions.

Note, however that the software license has changed to GPL 2.0.
